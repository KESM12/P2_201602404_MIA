...
func WriteInBitmapInode(path string, superbloque *estructuras.SuperBloque) int64 {
	valor := byte('1')
...
func WriteInBitmapBlock(path string, superbloque *estructuras.SuperBloque) int64 {
	valor := byte('1')
...
func DeleteBitmapInode(path string, superbloque *estructuras.SuperBloque, posicion int64) {
	// valor := byte('0')
...
func DeleteBitmapBlock(path string, superbloque *estructuras.SuperBloque, posicion int64) {
	// valor := byte('0')
...
func SearchFirstFreeBitmapInodePos(path string, superbloque *estructuras.SuperBloque) int64 {
	contar := 0
...
func SearchFirstFreeBitmapBlockPos(path string, superbloque *estructuras.SuperBloque) int64 {
	contar := 0
...
func S_bm_inode_print(file *os.File, superbloque *estructuras.SuperBloque) {
	contador := 0
	bit := byte('2')
